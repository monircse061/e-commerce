                ...
                <table class="table table-condensed">
                    ...
                    <tr>
                        <td class="cart_product">
                            <a href=""><img src="{{url($v_contents->options->image)}}" height="80px" width="80px" alt=""></a>
                        </td>
                        ...
                        <td class="cart_delete">
                            <a class="cart_quantity_delete" href="{{url('/delete-to-cart/'.$v_contents->rowId)}}"><i class="fa fa-times"></i></a>
                        </td>
                    </tr>
                    <?php }?>
        ...
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="total_area">
                        ...
                        @else
                            <a class="btn btn-default update" href="{{url('/login-check')}}">CheckOut</a>
                        @endif
